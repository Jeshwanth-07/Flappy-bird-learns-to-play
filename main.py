...
STAT_FONT = pygame.font.SysFont("Brass Mono Regular", 50)


class Bird:
    IMGS = BIRD_IMGS
    MAX_ROTATION = 25  # Max rotation in degrees
    ...
    def __init__(self, x, y):
        ...
        self.y = y
        self.tilt = 0  # Facing direction
        self.tick_count = 0  # Physics tracking
        self.vel = 0
        self.height = self.y
        self.img_count = 0  # Image animation tracker
        self.img = self.IMGS[0]

    def jump(self):
        self.vel = -10.5  # Negative for upward movement
        self.tick_count = 0
        self.height = self.y
...
def draw_window(win, birds, pipes, base, score):
    ...
    text = STAT_FONT.render("Score: " + str(score), 1, (183, 110, 121))
